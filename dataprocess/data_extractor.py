...
def unirel_extractor(
    ...
    for tail_pred, tail_label in zip(tail_preds, tail_labels):
        ...
        for left, right in e2e:
            ...
            for l, r in [(left, right), (right, left)]:  # noqa E741
                ...
                if l in e_h2r and r in e_t2r:
                    ...
                    for rel in common_rels:
                        ...
                        pred_spo_span_list.add((l, rel, r))
                        pred_spo_text.add(
                            (tokenizer.decode(input_ids[l]), idx2pred[rel], tokenizer.decode(input_ids[r]))
                        )
