...
class UniRel:
    ...
    def _get_pred_str(self, dataset_name):
        ...
        self.pred_inputs = self.tokenizer.encode_plus(self.pred_str, add_special_tokens=False)
...
if __name__ == "__main__":
    ...
    match ds:
        ...
        case "webnlg":
            model_path = "output/webnlg/checkpoint-final"
    ...
    print(
        unirel.predict(
            ...
            + "Thailand, is organizing an expedition starting in November in Jinghong, a small city in the Yunnan "
            + "province in China."
        )
    )
    print(
    ...
    print(
        unirel.predict(
            [
                ...
                "In perhaps the most ambitious Mekong cruise attempt, Impulse Tourism, an operator based in Chiang Mai"
                + ", Thailand, is organizing an expedition starting in November in Jinghong, a small city in the"
